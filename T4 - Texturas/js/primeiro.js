...
var guiFunction = function(){
    ...
    gui.add(param, 'Veado');
    gui.add(param, 'Corvo');
    gui.add(param, 'Corvo2');
    gui.add(param, 'Galinha');
    gui.add(param, 'Galinha2');
    gui.add(param, 'Vaca');
...
var loadObj = function(){
    ...
    fbxLoader.load(
        ...
        function(object){
            ...
            galinha2.scale.x = 0.01;
            galinha2.scale.y = 0.01;
            galinha2.scale.z = 0.01;
            galinha2.position.x = 15;
            galinha2.position.z = 35;
            galinha2.position.y = 10;
            galinha2.rotation.y = 0.8;
            galinha2.castShadow = true;
            scene.add(galinha2); 
            console.log(galinha2);
    ...
    fbxLoader.load(
        ...
        function(object){
            ...
            corvo2.scale.x = 0.008;
            corvo2.scale.y = 0.008;
            corvo2.scale.z = 0.008;
            corvo2.position.x = 26;
            corvo2.position.z = 30;
            corvo2.position.y = 10;
            corvo2.rotation.y -= 0.85;
            scene.add(corvo2);    
